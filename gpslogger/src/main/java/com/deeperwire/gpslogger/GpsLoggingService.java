...
import com.deeperwire.gpslogger.common.*;
...
import com.deeperwire.gpslogger.loggers.FileLoggerFactory;
import com.deeperwire.gpslogger.loggers.Files;
import com.deeperwire.gpslogger.loggers.nmea.NmeaFileLogger;
import com.deeperwire.gpslogger.senders.AlarmReceiver;
...
public class GpsLoggingService extends Service implements SensorEventListener {
    ...
    private void notifyByBroadcast(boolean loggingStarted) {
            ...
            sendIntent.setAction("com.deeperwire.gpslogger.EVENT");
    ...
    private Notification getNotification() {
        ...
        annotateIntent.setAction("com.deeperwire.gpslogger.NOTIFICATION_BUTTON");
