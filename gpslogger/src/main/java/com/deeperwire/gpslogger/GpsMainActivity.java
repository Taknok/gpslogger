...
import com.deeperwire.gpslogger.common.EventBusHook;
import com.deeperwire.gpslogger.common.PreferenceHelper;
import com.deeperwire.gpslogger.common.PreferenceNames;
import com.deeperwire.gpslogger.common.Session;
import com.deeperwire.gpslogger.common.Strings;
import com.deeperwire.gpslogger.common.Systems;
import com.deeperwire.gpslogger.common.events.CommandEvents;
import com.deeperwire.gpslogger.common.events.ProfileEvents;
import com.deeperwire.gpslogger.common.events.ServiceEvents;
import com.deeperwire.gpslogger.common.events.UploadEvents;
import com.deeperwire.gpslogger.common.network.ConscryptProviderInstaller;
import com.deeperwire.gpslogger.common.slf4j.Logs;
import com.deeperwire.gpslogger.common.slf4j.SessionLogcatAppender;
import com.deeperwire.gpslogger.loggers.Files;
import com.deeperwire.gpslogger.senders.FileSender;
import com.deeperwire.gpslogger.senders.FileSenderFactory;
import com.deeperwire.gpslogger.ui.Dialogs;
import com.deeperwire.gpslogger.ui.components.GpsLoggerDrawerItem;
import com.deeperwire.gpslogger.ui.fragments.display.AnnotationViewFragment;
import com.deeperwire.gpslogger.ui.fragments.display.GenericViewFragment;
import com.deeperwire.gpslogger.ui.fragments.display.GpsBigViewFragment;
import com.deeperwire.gpslogger.ui.fragments.display.GpsDetailedViewFragment;
import com.deeperwire.gpslogger.ui.fragments.display.GpsLogViewFragment;
import com.deeperwire.gpslogger.ui.fragments.display.GpsSimpleViewFragment;
            ...
            if(selectedItems.contains(getString(R.string.sharing_location_only))){
                ...
                for (String path : selectedItems) {
                    ...
                    Uri providedUri = FileProvider.getUriForFile(getApplicationContext(),
                            "com.deeperwire.gpslogger.fileprovider", file);
